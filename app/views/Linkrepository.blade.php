...
<div class="mylink-item">             
        <div class="mylink-info">
            ...
            <div class="mylink-info-back">
                ...
                <a style="float:left; margin:13px;" href="favourites?link={{$link->link}}"><img alt="Favorites" src="images/favo.png"height=25 width=25 /></a>
                <a style="float:right; margin:13px;" href="share?link={{$link->link}}"><img alt="Share" src="images/share.png"height=25 width=25 /></a>
                <p>
                Visits: {{$link->counter}} <a href="tovisit?link={{$link->link}}" target="_blank">Visit Link</a>
                <br>
                 {{$link->description}}<br/> <a class="try-2" href="">Read More</a></p>
            </div>    
        </div>
    </div>
